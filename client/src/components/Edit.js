...
const Edit = () => {
    ...
    const updateuser = async (e) => {
        ...
        if (!mobile || isNaN(mobile) || String(mobile).length !== 10) newErrors.mobile = 'Mobile should be 10-digit number';
        if (!age || isNaN(age) || age <= 0 || age >= 100) newErrors.age = 'Age should be 1 to 99';
        ...
        const res = await fetch(`/updateuser/${id}`, {
            ...
            body: JSON.stringify({ name, email, age, gender, mobile, state, district, add, date }),
        });
        const data = await res.json();
                ...
                <form onSubmit={updateuser}>
                    <div className="row">
                        <div className="mb-3 col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" value={inpval.name} onChange={setdata} name="name" className="form-control" />
                    ...
                    <div className="row">
                        ...
                        <div className="mb-3 col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" value={inpval.age} onChange={setdata} name="age" className="form-control" />
                            {errors.age && <div className="text-danger" style={{ fontSize: 13, marginTop: 4 }}>{errors.age}</div>}
                        </div>
                        <div className="mb-3 col-lg-6 col-md-6 col-12">
                            <label className="form-label">Mobile</label>
                            <input type="text" value={inpval.mobile} onChange={setdata} name="mobile" className="form-control" />
